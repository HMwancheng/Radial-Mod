...
public abstract class IconEnabledSlotMode implements SlotMode {
    ...
    protected void buildIconRow(SlotEditorScreen screen, RadialSlot slot, int width, LinearLayout container) {
        ...
        Button browseIconButton = Button.builder(
                        ...
                        btn -> Minecraft.getInstance().gui.setScreen(new IconPickerScreen(screen, id -> {
        ...
        // Hand Button
        Button handButton = Button.builder(Component.translatable("screen.radial.editor.hand"), btn -> {
